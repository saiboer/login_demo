  ...
  return (
    <div className="relative mx-auto scale-[0.68] origin-bottom sm:scale-[0.82] lg:scale-100" style={{ width: "550px", height: "400px" }}>
      ...
      >
        ...
        >
        <div
          className="absolute flex gap-8 transition-all duration-150 ease-out"
          style={{
      ...
      >
        ...
        >
        <div
          className="absolute flex gap-6 transition-all duration-150 ease-out"
          style={{
            left: isPasswordVisible
              ? "10px"
              : isLookingAtEachOther
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            top: isPasswordVisible ? "35px" : `${40 + orangePos.faceY + (isLookingTowardForm ? -6 : 0)}px`,
          }}
        >
        ...
        <div
          ...
          style={{
            ...
            top: isPasswordVisible ? "66px" : isLookingTowardForm ? "72px" : `${74 + orangePos.faceY}px`,
            width: "40px",
      ...
      >
        ...
        <div
          className="absolute h-[4px] w-20 rounded-full bg-[#2D2D2D] transition-all duration-150 ease-out"
          style={{
  ...
  ({ text = "Button", icon, className, ...props }, ref) => {
    return (
      ...
      >
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100 shadow-[0_0_20px_rgba(124,58,237,0.5)]">
          <span>{text}</span>
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-zinc-950 text-white">
      <div className="flex flex-col items-center gap-6">
        <div className="luma-spin">
          <span className="border-violet-500/30" />
          <span className="border-fuchsia-500/30" />
          <span className="border-indigo-500/30" />
        </div>
        <p className="text-sm tracking-[0.24em] text-violet-200/70 uppercase">Loading CareerCompass...</p>
      </div>
    </div>
  );
}
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-8 sm:px-10">
        <header className="flex items-center justify-between rounded-full border border-white/10 bg-white/5 px-5 py-4 backdrop-blur-xl">
          <div className="flex items-center gap-3">
            <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 p-0.5">
              <img
                src="https://i.postimg.cc/nLrDYrHW/icon.png"
                alt="CareerCompass logo"
                className="h-full w-full rounded-[10px] bg-zinc-950 object-contain p-1.5"
              />
            </div>
            <div>
              <p className="text-sm font-semibold tracking-wide">CareerCompass</p>
              <p className="text-xs text-violet-200/50">Post-login demo page</p>
            </div>
          </div>
          <button onClick={onReset} className="rounded-full border border-white/10 px-5 py-2 text-sm text-white/80 transition-all hover:bg-white/10 hover:border-white/20">
            Back To Demo
          </button>
        </header>

        <main className="flex flex-1 items-center justify-center relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-[500px] rounded-full bg-violet-600/10 blur-[120px]" />
          <div className="max-w-3xl text-center relative z-10">
            <p className="mb-6 inline-flex rounded-full border border-fuchsia-400/20 bg-fuchsia-400/10 px-4 py-2 text-xs font-medium uppercase tracking-[0.24em] text-fuchsia-200">
...
function HomeScreen({ onOpenLogin }: { onOpenLogin: () => void }) {
  return (
    <div className="home-shell min-h-screen overflow-hidden bg-zinc-950 text-white relative">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-fuchsia-600/20 blur-[150px] mix-blend-screen pointer-events-none" />
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-6 sm:px-10 lg:px-12 z-10">
        <header className="flex items-center justify-between rounded-full border border-white/10 bg-white/5 px-5 py-4 backdrop-blur-xl shadow-lg">
          <div className="flex items-center gap-3">
            <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 p-0.5">
              <img
                src="https://i.postimg.cc/nLrDYrHW/icon.png"
            ...
            <div>
              <p className="text-sm font-semibold tracking-wide">CareerCompass</p>
              <p className="text-xs text-violet-200/50">Demo landing page</p>
            </div>
          </div>
        ...
        <main className="relative flex flex-1 flex-col justify-center py-20 lg:py-10">
          <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <section className="relative">
              <div className="home-card rounded-[32px] border border-white/10 bg-white/[0.04] p-6 backdrop-blur-2xl shadow-[0_8px_32px_0_rgba(31,38,135,0.37)]">
                <div className="rounded-[28px] border border-white/5 bg-zinc-950/80 p-6 shadow-2xl backdrop-blur-md">
...
function LoginScreen({ onBack, onLoginComplete }: { onBack: () => void; onLoginComplete: () => void }) {
  ...
  return (
    <div className="min-h-screen max-h-screen overflow-hidden grid lg:grid-cols-2 bg-zinc-50 text-zinc-950 login-enter">
      <div className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-[#05050A] p-12 text-white">
        <div className="relative z-20 flex items-center justify-between">
          <a href="#" onClick={(e) => e.preventDefault()} className="flex items-center gap-3 text-lg font-semibold tracking-wide">
            <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 p-0.5">
              <img
                src="https://i.postimg.cc/nLrDYrHW/icon.png"
                alt="CareerCompass logo"
        ...
        <div className="absolute right-0 top-0 size-[500px] rounded-full bg-violet-600/20 blur-[130px]" />
        <div className="absolute bottom-0 left-0 size-[600px] rounded-full bg-fuchsia-600/15 blur-[150px]" />
      </div>

      <div className="flex items-center justify-center bg-zinc-50 p-8 relative">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(124,58,237,0.03),transparent_100%)] pointer-events-none" />
        <div className="w-full max-w-[420px] login-form-enter relative z-10">
          <div className="mb-12 flex items-center justify-between lg:hidden">
            <div className="flex items-center gap-3 text-lg font-semibold tracking-wide text-zinc-950">
              <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-fuchsia-600 p-0.5">
                  <img
                    src="https://i.postimg.cc/nLrDYrHW/icon.png"
                    alt="CareerCompass logo"
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-zinc-200/60 bg-white/70 px-4 text-sm outline-none transition-all focus:border-violet-500 focus:bg-white focus:ring-[3px] focus:ring-violet-500/20 shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-zinc-200/60 bg-white/70 px-4 pr-11 text-sm outline-none transition-all focus:border-violet-500 focus:bg-white focus:ring-[3px] focus:ring-violet-500/20 shadow-sm"
                />
                <button
                  type="button"
            ...
            <button
              ...
              disabled={isLoading}
              className={cn(
                "relative group flex h-12 w-full items-center justify-center overflow-hidden rounded-xl bg-zinc-950 text-base font-medium text-white transition-all disabled:opacity-70 disabled:cursor-not-allowed",
                !isLoading && "hover:shadow-[0_0_20px_rgba(124,58,237,0.4)]"
              )}
              onMouseEnter={() => {
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-violet-600 to-fuchsia-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-zinc-50 px-2 text-zinc-500 font-medium">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-6">
            <button
              type="button"
              className="group flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-zinc-200 bg-white text-sm font-semibold text-zinc-900 transition-all hover:bg-zinc-50 focus:ring-[3px] focus:ring-zinc-200/50"
            >
                <svg
                  className="h-5 w-5"
                  aria-hidden="true"
          ...
          <div className="mt-8 text-center text-sm text-zinc-500">
            Don&apos;t have an account? <a href="#" className="font-semibold text-violet-600 hover:text-violet-500 hover:underline">Sign Up</a>
          </div>
        </div>
      </div>
    </div>
